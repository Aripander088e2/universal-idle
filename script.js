...
function loop(ms){
  ...
  document.getElementById("uniReset").innerHTML = (game.atoms.gte(1e80) && game.size.gte(8.8e26)) ? "Reset for " + formate(game.atoms.div(1e80).pow(new Decimal(0.0125).mul(new Decimal(2).log10())), 2) + " Universe Points" : "Reach " + formate(new Decimal(1e80)) + " atoms and " + formate(new Decimal(8.8e26)) + " meters to reset"
